...
from bdilab_server.bdilab_detect.saving.loading import load_detector as _load_detector
from bdilab_server.bdilab_detect.saving.saving import save_detector as _save_detector
from bdilab_server.bdilab_detect.base import ConfigurableDetector, Detector
